function [h] = plot_sensor_Tango_frame(R_gc, p_gc, camScale, camBodyColor)
% Project:    Astrobee's mapping and localization system
% Function:  plot_sensor_Tango_frame
%
% Description:
%   draw current Tango camera frame in the current figure
%
% Example:
%   OUTPUT:
%   h: plot handler
